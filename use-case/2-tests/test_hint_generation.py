...
from GenerativeProteomics.dataset import Data, generate_hint
import numpy as np
import unittest
...
class TestImputation(unittest.TestCase):
    def test_hint_generation(self):
        ...
        print("Hint matrix generated successfully")
        np.testing.assert_array_equal(file1, output.values, "Hint matrix generated unsuccessfully")
